...
class NetFlixTestPage extends StatelessWidget {
  const NetFlixTestPage({Key? key}) : super(key: key);
                ...
                Container()
                    .backgroundImage(DecorationImage(
                        image: CachedNetworkImageProvider(tmdb.images
                            .getUrl('wv22frLmCpXDRjKj4MWFwa4eTOK.jpg')!),
                        fit: BoxFit.cover))
                    .height(480),
                Container(
...
main() async {
  return await startApp(NetFlixTestPage());
}
